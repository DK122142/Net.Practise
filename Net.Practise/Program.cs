...
namespace Net.Practise
{
    class Program
    {
        ...
        {
            // Console.WriteLine("Считать с клавиатуры число и вывести все его цифры отдельно");
            // Task.DigitsOfNumber();
            //
            // Console.WriteLine("Вывести отдельно дробную, отдельно целую части числа");
            // Task.FractionInteger(342.679);
            //
            // Console.WriteLine("Найти максимальную цифру в числе");
            // Task.MaxDigitOfNumber(48627);
            //
            // Console.WriteLine("Найти минимальную цифру в числе");
            // Task.MinDigitOfNumber(48627);
            //
            // Console.WriteLine("Написать метод, который принимает строку и печатает на экран все ее символы, которые являются цифрой");
            // Task.PrintOnlyDigits("4dg5gdfe09efw7wef8@6sdf");
            //
            // Console.WriteLine("Представить текущую дату и время в формате ISO-8601");
            // Task.FormatCurrentDate();
            //
            // Console.WriteLine("Дана строка с датой: “2016 21-07”. Распарсить в дейт тайм");
            ...
            Console.WriteLine("Отсортировать массив из 39. Быстрая сортировка.");
            Task.QuickSort();
        }
    }
}
